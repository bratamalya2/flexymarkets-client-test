...
const TradeList = () => {
    ...
    const handleAddToWatchList = async (traderId) => {
        try {
            const response = await addMasterTraderIntoWatchList({ masterTraderId: traderId }).unwrap();
            if (response?.status) {
                            ...
                            >
                                ...
                                <TableCell align="right">
                                    ...
                                    <Button
                                        ...
                                        onClick={() => handleAddToWatchList(trader?.id)}
                                    >
                                        Add To Watch List
                                    </Button>
                                </TableCell>
