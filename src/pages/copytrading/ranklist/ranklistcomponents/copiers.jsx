...
const PodiumCard = ({ trader, onClick }) => {
  ...
  return (
    <Card
      ...
      onClick={onClick} // Pass onClick prop here
    >
      ...
      <Button
        ...
        onClick={(e) => {
          ...
          onClick(); // Navigate when copy button is clicked
        }}
        sx={{
          bgcolor: theme.palette.mode === 'dark' ? theme.palette.primary.main : '#1a1a1a',
          color: 'white',
          borderRadius: 10,
          textTransform: 'none',
          py: 1,
          '&:hover': { bgcolor: theme.palette.mode === 'dark' ? theme.palette.primary.dark : '#333' }
        }}
      >
        Copy
      </Button>
      ...
      <Container maxWidth="lg">
        ...
        <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 2 }}>
          <Stack direction="row" alignItems="center" spacing={1}>
            ...
            <Typography
              ...
              color="primary"
              sx={{ cursor: 'pointer' }}
              onClick={handleNavigate} // Make "view more" clickable
            >
              view more
            </Typography>
          </Stack>
        ...
        <Paper elevation={0} sx={{ border: '1px solid', borderColor: theme.palette.divider, borderRadius: 4, overflow: 'hidden', bgcolor: 'background.paper' }}>
          ...
          {STRATEGY_LIST.map((item, idx) => (
            <Box
              key={idx}
              onClick={handleNavigate} // Add click handler to row
              sx={{
                px: 3,
                py: 2,
                borderTop: '1px solid',
                  ...
                  <Stack direction="row" justifyContent="flex-end" spacing={1} alignItems="center">
                    ...
                    <Button
                      onClick={(e) => {
                        ...
                        handleNavigate(); // Navigate on copy button click
                      }}
                      size="small"
                      variant="contained"
                      sx={{ bgcolor: theme.palette.mode === 'dark' ? theme.palette.primary.main : '#1a1a1a', color: 'white', borderRadius: 2, textTransform: 'none', '&:hover': { bgcolor: theme.palette.mode === 'dark' ? theme.palette.primary.dark : '#333' } }}
                    >
                      Copy
                    </Button>
                  </Stack>
...
export default CopiersDashboard;
