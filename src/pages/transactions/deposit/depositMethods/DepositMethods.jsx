...
function DepositMethods() {
    ...
    const availableMethods = DepositMethodsData.filter(m => m.specification !== "Unavailable" && m.to);
    const unavailableMethods = DepositMethodsData.filter(m => m.specification === "Unavailable" || !m.to);
    ...
    return (
        <Stack spacing={3} mb={"2rem"}>
            ...
            >
                <Stack spacing={1}>
                    <Typography variant="subtitle2" fontWeight={600} color="primary">Deposit Information</Typography>
            ...
            <Box>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}>
                    ...
                    <Tooltip title="Click chips for details">
                        <IconButton size="small" onClick={(e) => handleInfoClick(e, "• Minimum deposit amount varies by method\n• Most deposits are processed instantly\n• No deposit fees from our side\n• Contact support for any issues")}
                ...
                <Stack direction="row" spacing={1} sx={{ flexWrap: 'wrap', gap: 1 }}>
                    <Chip icon={<AttachMoneyIcon fontSize="small" />} label="Min deposit varies" size="small" variant="outlined" color="info" sx={{ fontSize: '0.75rem' }}
                        onClick={(e) => handleInfoClick(e, "Minimum deposit amount varies by method. Check each method for specific limits.")} />
                    <Chip icon={<CheckCircleIcon fontSize="small" />} label="Instant processing" size="small" variant="outlined" color="success" sx={{ fontSize: '0.75rem' }}
                    ...
                    <Chip icon={<MoneyOffIcon fontSize="small" />} label="No deposit fees" size="small" variant="outlined" color="success" sx={{ fontSize: '0.75rem' }}
