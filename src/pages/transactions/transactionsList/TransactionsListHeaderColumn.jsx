...
export const TransactionsListHeaderColumn = [
    ...
    //     size: 100,
    // }),
    columnHelper.accessor('mt5Login', {
        header: 'MT5 Login / Wallet',
        size: 100,
        Cell: ({ row }) => {
            const mt5Login = row.original.mt5Login ? row.original.mt5Login : "Wallet";
            return (<Typography>{mt5Login}</Typography>);
        },
    }),
